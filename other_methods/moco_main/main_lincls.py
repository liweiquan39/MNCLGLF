...
parser.add_argument('-data', default='/home/liweiquan/data/tiny-imagenet-200', metavar='DIR',
...
parser.add_argument('--wd', '--weight-decay', default=0., type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('-p', '--print-freq', default=196, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    valdir = os.path.join(args.data, 'val-m')
