...
parser.add_argument('-data', metavar='DIR', default='/home/liweiquan/data/cifar10/cifar-10-png',
...
parser.add_argument('--wd', '--weight-decay', default=0., type=float,
                    ...
                    dest='weight_decay')
parser.add_argument('-p', '--print-freq', default=392, type=int,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    valdir = os.path.join(args.data, 'test-m')
...
def save_checkpoint(state, is_best, filename='checkpoint_fine.pth.tar'):
